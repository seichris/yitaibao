                ...
                >
                    ...
                    <div style={styles.nextButtonsRowContainer}>
                        <div style={this.state.nextButtonStyle}>
                                <div style={styles.buttonRow}>
                                    <a href='https://info.ethhongbao.com/' className='history-button no-underline' style={{ ...styles.aboutContainer, color: '#0099ff' }}>
                                        <span style={styles.nextButtonTitle}>About</span>
                                    </a>
                                    <a href='https://info.ethhongbao.com/faq'>
                                        <div className="faq-icon" style={{ width: 59, height: 59 }}>
                                            <RetinaImage src="https://ethhongbao.com/images/q.png" />
                                        </div>
                                    </a>
