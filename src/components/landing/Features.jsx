    ...
    render() {
        return (
		    ...
		    <div className="img-container">
                      <RetinaImage className="img-responsive" src="https://ethhongbao.com/images/secure.png" />
		    </div>
		  ...
		  <Col xs={12} sm={3}>
		    <div className="img-container">		    
                      <RetinaImage className="img-responsive" src="https://ethhongbao.com/images/private.png" />
		    </div>
                  ...
                  <Col xs={12} sm={3}>
		    <div className="img-container">
                      <RetinaImage className="img-responsive" src="https://ethhongbao.com/images/cancellable.png" />
		    </div>
		      ...
		      All the transactions could be cancelled until received. That means if you’ve messed something up, you can always get your ether back if receiver hasn’t yet requested them.
                  ...
                  <Col xs={12} sm={3}>
		    <div className="img-container">		    
                      <RetinaImage  className="img-responsive" src="https://ethhongbao.com/images/nowallet.png" />
		    </div>
