    ...
    _renderStaticRouter() {
        return (
            <Router>
			    ...
			    window.location = 'https://info.ethhongbao.com';
			}} />
                        <Route path="/about" component={() => window.location = 'https://info.ethhongbao.com/'} />
                        <Route path="/faq" component={() => window.location = 'https://info.ethhongbao.com/faq/'} />
